...
<?
      ...
      $sql = "INSERT INTO playlist$pl_num(pl_no,song_no) VALUES($pl_num,$add_no)";
      $connect->query($sql);
        ...
        <center>
          <div class="w3-pannel w3-card w3-padding-16" style="width:60%">
            ...
            <div class="w3-container">
              <form action='./mylist_add_page.php?' name='s_name' method='get' >
              ...
              <table class="w3-table w3-striped w3-myfont">
                ...
                while($row = mysqli_fetch_assoc($result)){
                   print "<tr>";
                      ...
                      print "<td>"
                      ?>
                      <a class="w3-button w3-middle w3-green w3-hover-grey" href = "mylist_add_page.php?&s_no=<?echo $row['song_no']?>&s_name=<?echo $s_name?>" >추가</a>
                      <?
                      "</td>";
                    print "</tr>";
               }
        ...
        <center>
          <div class="w3-pannel w3-card w3-padding-16" style="width:95%">
            ...
            <center>
              ...
              <br>
              <a class="w3-button w3-large w3-green w3-hover-grey w3-myfont" onclick = "go()" >완료</a>
            </center>
          </div>
          </div>
        </center>
